...
import com.sumit.dell_pc.sanisasakhis.MainActivity;
import com.sumit.dell_pc.sanisasakhis.R;
import com.sumit.dell_pc.sanisasakhis.auth.BaseActivty;
import com.sumit.dell_pc.sanisasakhis.auth.UserList;
import com.sumit.dell_pc.sanisasakhis.language.LangList;
import com.sumit.dell_pc.sanisasakhis.language.LangListAdapter;
            ...
            public void onClick(View view) {
                if (!uEmail.getText().toString().trim().equals("") && !uPassword.getText().toString().trim().equals("")) {
                    if (android.util.Patterns.EMAIL_ADDRESS.matcher(uEmail.getText().toString().trim()).matches()) {
                        ...
                        // Right Thing
                        mAuth.createUserWithEmailAndPassword(uEmail.getText().toString().trim(), uPassword.getText().toString().trim())
                                .addOnCompleteListener(com.sumit.dell_pc.sanisasakhis.auth.LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            userNewEntry(mAuth.getCurrentUser().getUid(), mAuth.getCurrentUser().getDisplayName(), mAuth.getCurrentUser().getEmail());
                                            FirebaseUser user = mAuth.getCurrentUser();
                                            updateUI(user);
                                        } else {
                                            // If sign in fails, display a message to the user.
                                            Log.w(TAG, "signInWithEmail:failure", task.getException());
                                            Toast.makeText(com.sumit.dell_pc.sanisasakhis.auth.LoginActivity.this, "Authentication failed.",
